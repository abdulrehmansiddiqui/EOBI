...
<section class="content-header">
    ...
    <?php } ?>
    <h1><a href="<?php echo base_url()."edit_voucher/cash_payment/0"; ?>" title="Go Back"><span style="color:#000;" class="fa fa-arrow-left "></span></a> Edit Cash Payment Voucher</h1>
</section>

<?php foreach($cpv as $post){ ?>
<form style="form-inline" id="supplierbill" method="post" action="<?= base_url()?>edit_voucher/cash_payment/<?php echo $post->id;?>">
    <!--  FLAME's 🔥 Code  -->
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="cpv_num">CPV #</label>
                        <input type="text" name="cpv_num" id="cpv_num" value="<?php echo $post->cpv_num;?>" class="form-control" placeholder="CPV #" >
                    </div>
                    <div class="form-group">
                        <label for="cpv_date">BRV Date</label>
                        <input type="text" name="cpv_date" id="cpv_date" value="<?php echo $post->cpv_date;?>" class="form-control datepicker" >
                    </div>
                </div>
            </div>
        </div>
