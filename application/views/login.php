...
<body class="login-page">
    <div class="login-box">
        ...
        <form action="<?php echo base_url();?>login/login_form" method="post" name="login" id="login">
            <p style="text-align:center;" ><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ14R8vnPZfmYuYj_T1z0_Lz1v9FPOZi1TiPHBgeSdIjxRzM3IT" width="200px" /></p>
