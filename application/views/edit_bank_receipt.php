...
<section class="content-header">
    ...
    <?php } ?>
    <h1><a href="<?php echo base_url()."edit_voucher/bank_receipt/0"; ?>" title="Go Back"><span style="color:#000;" class="fa fa-arrow-left "></span></a> Edit Bank Receipt Voucher</h1>
</section>

<?php foreach($brv as $post){ ?>
<form style="form-inline" id="supplierbill" method="post" action="<?= base_url()?>edit_voucher/bank_receipt/<?php echo $post->id;?>">
    <!--  FLAME's 🔥 Code  -->
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="brv_num" id="brv_num" value="<?php echo $post->brv_num;?>" class="form-control" placeholder="BRV #" >
                    </div>
                    <div class="form-group">
                        <label for="brv_date">BRV Date</label>
                        <input type="text" name="brv_date" id="brv_date" value="<?php echo $post->brv_date;?>" class="form-control datepicker" >
                    </div>
                </div>
            </div>
        </div>
