...
<section class="content-header">
    ...
    <?php } ?>
    <h1><a href="<?php echo base_url().""; ?>" title="Go Back"><span style="color:#000;" class="fa fa-arrow-left "></span></a> Cash Payment Voucher</h1>
</section>
<form style="form-inline" id="supplierbill" method="post" action="<?= base_url() ?>cash_payment/add_sales">
    <!--  FLAME's 🔥 Code  -->
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="brv_num">CPV #</label>
                        <input type="text" name="cpv_num" id="brv_num" class="form-control" placeholder="BRV #" >
                    </div>
                    <div class="form-group">
                        <label for="brv_date">CPV Date</label>
                        <input type="text" name="cpv_date" id="brv_date" class="form-control datepicker" >
                    </div>
                </div>
            </div>
        </div>
