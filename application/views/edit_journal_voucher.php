...
<section class="content-header">
    ...
    <?php } ?>
    <h1><a href="<?php echo base_url()."edit_voucher/journal_voucher/0"; ?>" title="Go Back"><span style="color:#000;" class="fa fa-arrow-left "></span></a> Edit Journal Voucher</h1>
</section>

<?php foreach($jv as $post){ ?>
<form style="form-inline" id="supplierbill" method="post" action="<?= base_url()?>edit_voucher/journal_voucher/<?php echo $post->id;?>">
    <!--  FLAME's 🔥 Code  -->
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="jv_num">JV #</label>
                        <input type="text" name="jv_num" id="jv_num" value="<?php echo $post->jv_num;?>" class="form-control" placeholder="JV #" >
                    </div>
                    <div class="form-group">
                        <label for="jv_date">JV Date</label>
                        <input type="text" name="jv_date" id="jv_date" value="<?php echo $post->jv_date;?>" class="form-control datepicker" >
                    </div>
                </div>
            </div>
        </div>
