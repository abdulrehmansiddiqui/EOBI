...
<section class="content-header">
    ...
    <?php } ?>
    <h1><a href="<?php echo base_url()."edit_voucher"; ?>" title="Go Back"><span style="color:#000;" class="fa fa-arrow-left "></span></a> Bank Payment Vouchers</h1>
</section>
        ...
        <div class="table-responsive">
                <table class="table w-100">
                    ...
                    <tr>
                        ...
                        <td><?php echo $post->bpv_date;?></td>
                        <td><?php echo $post->rs;?></td>
                        <td style="text-align:center">
                            <a class="btn btn-xs btn-success" href="<?php echo base_url()."edit_voucher/edit_bpv/$post->id"; ?>" title="Edit Item"><span class="fa fa-edit "></span></a>
