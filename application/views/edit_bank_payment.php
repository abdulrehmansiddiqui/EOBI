...
<section class="content-header">
    ...
    <?php } ?>
    <h1><a href="<?php echo base_url()."edit_voucher/bank_payment/0"; ?>" title="Go Back"><span style="color:#000;" class="fa fa-arrow-left "></span></a> Edit Bank Payment Voucher</h1>
</section>

<?php foreach($bpv as $post){ ?>
<form style="form-inline" id="supplierbill" method="post" action="<?= base_url()?>edit_voucher/bank_payment/<?php echo $post->id;?>">
    <!--  FLAME's 🔥 Code  -->
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="bpv_num" id="bpv_num" value="<?php echo $post->bpv_num;?>" class="form-control" placeholder="BPV #" >
                    </div>
                    <div class="form-group">
                        <label for="bpv_date">BPV Date</label>
                        <input type="text" name="bpv_date" id="bpv_date" value="<?php echo $post->bpv_date;?>" class="form-control datepicker" >
                    </div>
                </div>
            </div>
        </div>
