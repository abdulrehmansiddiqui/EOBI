...
<section class="content-header">
    ...
    <?php } ?>
    <h1><a href="<?php echo base_url().""; ?>" title="Go Back"><span style="color:#000;" class="fa fa-arrow-left "></span></a> Bank Receipt Vouchers</h1>
</section>

<form style="form-inline" id="supplierbill" method="post" action="<?= base_url() ?>bank_receipt/add_sales">
    <!--  FLAME's 🔥 Code  -->
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="sent_to" id="sent_to" class="form-control" placeholder="Account Of." >
